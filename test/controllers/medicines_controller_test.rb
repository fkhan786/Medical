...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { description: @medicine.description, image_url: @medicine.image_url, price: @medicine.price, title: @medicine.title }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { description: @medicine.description, image_url: @medicine.image_url, price: @medicine.price, title: @medicine.title }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
